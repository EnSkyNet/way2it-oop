...
public class StringsTest {
    public static void main(String[] args) {
        ...
        System.out.println("Char \"o\" in all elements of list: " + stringList.stream().allMatch(a -> a.contains("o")));
        System.out.println("Add _1 for elements of list: " + stringList.stream().map(s -> s + "_1").toList());
        System.out.println("Sorted list without doubles: " + stringList.stream().distinct().sorted().toList());
    }
}
