...
public class WarriorTest {
    public static void main(String[] args) {
        Сrossbowman сrossbowman = new Сrossbowman(10, 8);
        Spearman spearman = new Spearman(10, 12);
        Swordsman swordsman = new Swordsman(10, 13);

        Warrior[] warriors = new Warrior[]{сrossbowman, spearman, swordsman};
